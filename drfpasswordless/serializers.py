    ...
    def validate(self, attrs):
        ...
        if alias:
            ...
            if api_settings.PASSWORDLESS_REGISTER_NEW_USERS is True:
                ...
                user, user_created = User.objects.get_or_create(**{self.alias_type: alias})
    ...
    def validate(self, attrs):
        ...
        try:
            ...
            token = CallbackToken.objects.get(
                **{"user": user, "key": callback_token, "type": CallbackToken.TOKEN_TYPE_AUTH, "is_active": True}
            )
...
class CallbackTokenVerificationSerializer(AbstractBaseCallbackTokenSerializer):
    ...
    def validate(self, attrs):
        try:
            ...
            token = CallbackToken.objects.get(
                **{"user": user, "key": callback_token, "type": CallbackToken.TOKEN_TYPE_VERIFY, "is_active": True}
            )
